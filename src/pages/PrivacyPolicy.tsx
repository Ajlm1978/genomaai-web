...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Política de Privacidad | Genoma AI</title>
        <meta name="description" content="Política de privacidad de Genoma AI. Conoce cómo recopilamos, usamos y protegemos tu información personal." />
        <meta property="og:title" content="Política de Privacidad | Genoma AI" />
        <meta property="og:url" content="https://genomai.ai/privacy-policy" />
        <link rel="canonical" href="https://genomai.ai/privacy-policy" />
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-sm max-w-none text-gray-300 space-y-6">
            ...
            <p>
              {isEs
                ? "Si tiene preguntas sobre esta política de privacidad, contáctenos en ventas@genomai.ai"
                : "If you have questions about this privacy policy, contact us at ventas@genomai.ai"}
            </p>
          </div>
        </div>
      </div>
