...
const AIOrb = () => {
  ...
  const aiResponses = [
    "Hi! I'm Fenix AI. I can help you discover how our AI solutions can transform your business. What industry are you in?",
    ...
    <>
      ...
      >
        <div className="relative">
          {/* Outer glow */}
          <div className="orb w-24 h-24 rounded-full absolute inset-0 animate-glow-pulse" />
          
          {/* Core orb */}
          <div className="orb-core w-16 h-16 rounded-full absolute top-4 left-4 animate-breathe">
            <div className="w-full h-full rounded-full bg-gradient-to-br from-primary to-secondary opacity-90" />
          </div>
          ...
          <div className="glass-card w-full max-w-md h-[600px] flex flex-col animate-scale-in">
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full orb-core" />
                <div>
                  <h3 className="font-semibold text-white">Fenix AI Assistant</h3>
